export function DataSources() {
  return (
    <div className="max-w-3xl mx-auto prose prose-sm prose-gray">
      ...
      <p>
        Die Standardwerte des Modells basieren auf öffentlich verfügbaren Daten und
        Branchenschätzungen. Alle Parameter sind transparent und können angepasst werden.
      </p>

      <h2>Primärquellen</h2>
      <ul>
        <li>
          <strong>Bundesnetzagentur (BNetzA)</strong> — Marktteilnehmerzahlen, Monitoring-Berichte
          <br />
          <a href="https://www.bundesnetzagentur.de/" target="_blank" rel="noopener">
            bundesnetzagentur.de
          </a>
        </li>
        <li>
          <strong>Marktstammdatenregister (MaStR)</strong> — Registrierte Marktakteure
          <br />
          <a href="https://www.marktstammdatenregister.de/" target="_blank" rel="noopener">
            marktstammdatenregister.de
          </a>
        </li>
        <li>
          <strong>BDEW / edi@energy</strong> — Spezifikationen, Release-Zyklen, Nachrichtenformate
          <br />
      ...
      <ol>
        <li>3-5 anonyme Stadtwerke-Datenpunkte zur Validierung der Stückkosten</li>
