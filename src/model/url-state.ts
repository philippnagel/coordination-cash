...
function mergeDefaults(partial: Partial<ModelInputs>): ModelInputs {
  return {
    ...
    participants: {
      ...
      medium: partial.participants?.medium ?? DEFAULT_INPUTS.participants.medium,
    ...
    costs: {
      implMaintenance: partial.costs?.implMaintenance ?? DEFAULT_INPUTS.costs.implMaintenance,
      ...
      updateLarge: partial.costs?.updateLarge ?? DEFAULT_INPUTS.costs.updateLarge,
      updateMedium: partial.costs?.updateMedium ?? DEFAULT_INPUTS.costs.updateMedium,
      updateSmall: partial.costs?.updateSmall ?? DEFAULT_INPUTS.costs.updateSmall,
      frictionResolution: partial.costs?.frictionResolution ?? DEFAULT_INPUTS.costs.frictionResolution,
    },
    sectorMultipliers: {
      implementation: partial.sectorMultipliers?.implementation ?? DEFAULT_INPUTS.sectorMultipliers.implementation,
      operations: partial.sectorMultipliers?.operations ?? DEFAULT_INPUTS.sectorMultipliers.operations,
      update: partial.sectorMultipliers?.update ?? DEFAULT_INPUTS.sectorMultipliers.update,
      friction: partial.sectorMultipliers?.friction ?? DEFAULT_INPUTS.sectorMultipliers.friction,
    },
  };
}
