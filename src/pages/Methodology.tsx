export function Methodology() {
	return (
		<div className="max-w-3xl mx-auto prose prose-sm prose-gray">
			...
			<p>
				Das edi@energy-System ist eine{" "}
           ...
           + (C_friction × θ_friction)`}
			...
			<p>
				<code>I × C_impl</code> — Die Kosten für die Wartung von ca. 75
				unabhängigen Softwareimplementierungen derselben Spezifikation. Jede
				Implementierung benötigt ein Entwicklungsteam, Infrastruktur und
			...
			<p>
				<code>U × (I × C_update_impl + Σ(P_tier × C_update_tier))</code> — Die
				Kosten regulatorischer Update-Zyklen (GPKE, WiM, MaBiS, GeLi). Alle
				Implementierungen und alle Teilnehmer müssen sich gleichzeitig
				aktualisieren. Die Kosten sind nach Teilnehmergröße gestaffelt.
			</p>
			...
			<p>
				Das edi@energy-System regelt sowohl Strom- als auch Gasmärkte. Statt
				parallele Modelle zu bauen, werden θ-Multiplikatoren auf das Basismodell
				(Strom) angewendet:
			</p>
			<ul>
				<li>
					<strong>θ_impl = 1,1</strong> — Die meisten Plattformen decken beides
					ab; ca. 10% Gas-spezifisch
				</li>
				<li>
					<strong>θ_ops = 1,25</strong> — Ca. 25% zusätzliche Gas-only-Akteure
				</li>
				<li>
					<strong>θ_update = 1,3</strong> — Gasprozesse werden gebündelt,
			...
			<ul>
				<li>
					Dies ist ein <strong>Schätzmodell</strong>, keine Prüfung
				</li>
				<li>Standardwerte sind fundierte Schätzungen, keine Messungen</li>
				<li>
					Nicht enthalten: Verbraucherabrechnung, externe Beratung,
					Opportunitätskosten
				</li>
				<li>Sektormultiplikatoren sind Näherungen</li>
				<li>
					Das Modell geht von der aktuellen Architektur aus (kein AS4-Übergang)
				</li>
			</ul>
		</div>
	);
