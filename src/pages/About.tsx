  ...
  return (
    <div className="max-w-3xl mx-auto prose prose-sm prose-gray">
      ...
      <p>
        ...
        <strong>verpflichtende Koordinationsinfrastruktur</strong>. Etwa 2.500 Marktteilnehmer in
        der Strom- und Gaswirtschaft müssen dieselbe Spezifikation implementieren, sich bei
        regulatorischen Updates synchronisieren und hunderte Millionen standardisierter Nachrichten
        austauschen.
      </p>
      <p>
        Die Kosten dieses Systems sind real, aber verteilt und unsichtbar. Dieses Tool macht sie
        sichtbar und ermöglicht einen informierten Diskurs über Alternativen.
      </p>

      <h2>Was dieses Modell ist</h2>
      <ul>
        <li>Ein <strong>Schätzmodell</strong> mit transparenten Annahmen</li>
      ...
      <h2>Kontakt</h2>
      <p>
        Dieses Projekt ist Open Source. Feedback, Korrekturen und Datenpunkte sind willkommen.
      </p>
    </div>
  );
}
